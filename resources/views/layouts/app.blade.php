            ...
            <div>
                ...
                <nav class="p-4 space-y-1">
                    @if(Auth::user()->role === 'keuangan')
                        ...
                        <a href="{{ route('keuangan.transactions') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all text-sm {{ Route::is('keuangan.transactions') ? 'bg-indigo-600 text-white font-semibold shadow-md shadow-indigo-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
