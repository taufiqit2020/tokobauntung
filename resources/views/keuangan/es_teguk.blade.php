    ...
    <div class="right-col">
        ...
        <div class="banner">
            ...
            <div class="banner-icon">
                <img src="{{ asset('images/es-teguk-logo.jpg') }}" alt="Es Teguk" style="width:60px;height:60px;border-radius:12px;object-fit:cover;box-shadow:0 2px 8px rgba(0,0,0,0.15);">
            </div>
        </div>
